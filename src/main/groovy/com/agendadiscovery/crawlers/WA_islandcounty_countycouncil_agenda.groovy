...
//https://media.avcaptureall.com/#/?prefilter=278%2c-1&target=_blank&tabs=rec%7Cupc&regcode=
class WA_islandcounty_countycouncil_agenda extends BaseCrawler{
    ...
    public void getDocumentByPage(WebDriver driver) throws Exception {
        WebElement listBtn = driver.findElementByXPath("//span[contains(@class,\"glyphicon-list\")]")
        listBtn.click()
        sleep(2000)
